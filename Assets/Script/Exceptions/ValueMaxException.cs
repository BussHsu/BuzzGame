...
public class ValueMaxException : BaseException
{
	...
	public ValueMaxException (float fromValue, float toValue) : base (true)
	{
	...
	public float GetModifiedValue()
	{
		...
		{
			value = Mathf.Max(modifiers [i].Modify (fromValue,toValue), value);
		}
